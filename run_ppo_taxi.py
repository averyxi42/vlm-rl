...
test_wrapped_env = LLMProcessingWrapper(
    ...
    processor=processor,
    prompt_formatter=formatter,
    max_length=wrapper_kwargs['max_length']  # Use the same max_length as your final env
)
...
model = PPO(
    ...
    policy_kwargs={"device": DEVICE, "exploration_temperature": 2.0,'model_name':MODEL_NAME},
